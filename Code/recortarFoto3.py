    ...
    if len(puntos_validos)<=1:
        ...
        #Solo tengo el punto 4 y, el punto 2 o 3
            ...
            if(punto2==None):
                ...
                recortada_original = imagen[coordenadas_originales1[1]:coordenadas_originales3[1],
                                            coordenadas_originales1[0]:(coordenadas_originales1[0]+(coordenadas_originales3[1]-coordenadas_originales1[1]))]
            else:
                coordenadas_originales1 = [coordenadas1[0] + punto1[0], coordenadas1[1] + punto1[1]]
        ...
        #Solo tengo el punto 1 y, el punto 2 o 3
            ...
            if(punto2==None):
                coordenadas_originales4 = [coordenadas4[0] + punto4[0], coordenadas4[1] + punto4[1]]
                coordenadas_originales3 = [coordenadas3[0] + punto3[0], coordenadas3[1] + punto3[1]]
                recortada_original = imagen[(coordenadas_originales3[1]-(coordenadas_originales4[0]-coordenadas_originales3[0])):coordenadas_originales4[1],
                                            coordenadas_originales3[0]:coordenadas_originales4[0]]
            else:
                coordenadas_originales4 = [coordenadas4[0] + punto4[0], coordenadas4[1] + punto4[1]]
                coordenadas_originales2 = [coordenadas2[0] + punto2[0], coordenadas2[1] + punto2[1]]
                recortada_original = imagen[coordenadas_originales2[1]:coordenadas_originales4[1],
                                            (coordenadas_originales4[1]-coordenadas_originales2[1])-coordenadas_originales2[0]:coordenadas_originales4[0]]
